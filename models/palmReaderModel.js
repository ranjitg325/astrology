...
const palmReaderSchema = new mongoose.Schema({
    ...
    heartLineReading: {      //future of love life
        heartLineDiscription: { type: String, trim: true },
            ...
            DesignOfLine: {
                type: String,
                enum: ["lineOutSide", "betweenIndex", "belowMiddle", "belowTheBase", "belowTheIndex", "curvesDownward", "commenceWithFork"]
            }
        ...
        // clickImage: { type: String, required: true }, //CLICK OR UPLOAD IMAGE BY USER
    ...
    headLineReading: {    //whick kind of person you are
        headLineDiscription: { type: String, trim: true },
            ...
            DesignOfLine: {
            type: String, 
            enum: ["beginFromInside", "joinedAndStraight", "joinedAndForked", "joinedAndBendsDownward", "joinedAndBendsTooFarDownward", "joinedAndCurved", "seperateBothLine", "seperateBothLineAndDownward", "DoubleHeadLine"] 
        }
    ...
    lifeLineReading: {
        lifeLineDiscription: { type: String, trim: true },
            ...
            DesignOfLine: {
             type: String, 
             enum: ["straight", "short", "crossingThePalm", "rounded"] 
            },
    ...
    fateLineReading: {    //it tells about your career,work, struggle, success
        fateLineDiscription: { type: String, trim: true },
            ...
            DesignOfLine: {
             type: String, 
             enum: ["beginAtMiddle", "endAtHeartLine", "towardsTheHeadLine", "noFateLine", "lineWithBranches", "crossedByAnotherLine", "mountOfMoon", "beginFromLifeLine", "brokenFateLine", "cutByHorizontalLine"] 
            },
    ...
    marriageLineReading: {
        marriageLineDiscription: { type: String, trim: true },
            ...
            DesignOfLine: { 
            type: String, 
            enum: ["straightAndClear", "clearButBreak", "curvesDownward", "curvesUpward", "droppingLines", "islandAtBeginningOfLine", "", "islandAtMiddleOfLine", "islandAtEndOfLine", "manyIsland", "forkedLines", "forkedAndDownward", "joinUpward"] 
        },
        ...
        // clickImage: { type: String, required: true},  //CLICK OR UPLOAD IMAGE BY USER
        // finalResult: { type: String, required: true,trim: true }  //final descriptive future prediction
    },
     DesignOfLineImage: {
            type: String,
            required: true,
    ...
    clickImage: {   //for user only if he want to upload image
        type: String,
         //required: true
        },  //CLICK OR UPLOAD IMAGE BY USER

    finalResult: {
        type: String,
        required: true,
        trim: true
    } , //final descriptive future prediction
